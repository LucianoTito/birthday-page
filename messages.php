...
$con = conectar();
$sql = "INSERT INTO dedicatoria (nombre, mensaje) VALUES ('$nombre', '$mensaje')";
$resul = mysqli_query($con, $sql) or trigger_error("Query Failed! SQL -Error: ".mysqli_error($con), E_USER_ERROR);
